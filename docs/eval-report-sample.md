...
Backend unit tests：`backend/tests/` 共 **73** 個，全綠（memory / rag / hybrid / agent / guardrails / eval / export / attributes / vision-consent / messages / self-report / correlation / preferences / API layers）。
